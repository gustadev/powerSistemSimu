...
def main():
    ...
    instance.addConnection(BusConnection(bus1, bus2, z=complex(0.02, 0.04)))
    instance.addConnection(BusConnection(bus2, bus3, z=complex(0.0125, 0.025)))
    instance.addConnection(BusConnection(bus3, bus1, z=complex(0.01, 0.03)))
